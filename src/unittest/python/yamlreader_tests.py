...
class Test(unittest.TestCase):
    ...
    def test_should_correctly_merge_single_yaml_file(self):
        self.assertEqual(yaml_load("testdata/data1/input1.yaml"), self.data1_test1)
        
    def test_should_correctly_merge_list_of_yaml_files(self):
        self.assertEqual(yaml_load(["testdata/data1/input1.yaml", "testdata/data1/input2.yaml"]), self.data1_merged)
        
    def test_should_correctly_merge_tuple_of_yaml_files(self):
        self.assertEqual(yaml_load(("testdata/data1/input1.yaml", "testdata/data1/input2.yaml")), self.data1_merged)
        
    def test_should_correctly_merge_glob_of_yaml_files(self):
        self.assertEqual(yaml_load("testdata/data1/input?.yaml"), self.data1_merged)
